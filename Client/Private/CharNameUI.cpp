...
void CCharNameUI::Late_Tick(_float fTimeDelta)
{
	...
	else if(nullptr != m_pRendererCom && (m_ThrowUIinfo.iLevelIndex == LEVEL_GAMEPLAY || m_ThrowUIinfo.iLevelIndex == LEVEL_BATTLEENMU || m_ThrowUIinfo.iLevelIndex == LEVEL_BOSSENMU))
