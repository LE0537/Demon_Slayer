...
unsigned int APIENTRY Thread_AdvAkaza(void* pArg)
{
	...
	_float fValue[CRenderer::VALUE_END] = { 1.f, 0.37f ,0.1f ,182.f ,1571.f ,0.142f ,0.f ,1.36f,0.4f,1.f,20.f,20.f,0.07f,0.257f,0.3f,0.5f, 2.f, 0.4f,0.1f,0.3f,15.f,0.f,0.f, 0.07f };
	...
	pLoader->Get_Renderer()->Set_OriginValue(CRenderer::VALUETYPE(CRenderer::VALUE_ENVLIGHT), 0.257f);
	...
	pLoader->Get_Renderer()->Set_OriginValue(CRenderer::VALUETYPE(CRenderer::VALUE_LIGHTPOWER), 0.4f);
...
HRESULT CLevel_AdvAkaza::Ready_Lights()
{
	...
	LightDesc.vPosition = _float4(0.f, 36.f, -260.f, 1.f);
	LightDesc.fRange = 684.f;
	LightDesc.vDiffuse = _float4(1.f, 0.7f, 0.2f, 0.f);
	LightDesc.vAmbient = _float4(1.f, 1.f, 1.f, 1.f);
	LightDesc.vSpecular = _float4(1.f, 1.f, 1.f, 1.f);
	if (FAILED(pGameInstance->Add_Light(m_pDevice, m_pContext, LightDesc)))
	...
	ZeroMemory(&LightDesc, sizeof(LIGHTDESC));
	LightDesc.eType = LIGHTDESC::TYPE_POINT4;
	LightDesc.vPosition = _float4(0.f, 102.f, 360.f, 1.f);
	LightDesc.fRange = 143.f;
	LightDesc.vDiffuse = _float4(1.f, 1.f, 1.f, 1.f);
	LightDesc.vAmbient = _float4(1.f, 1.f, 1.f, 1.f);
	LightDesc.vSpecular = _float4(1.f, 1.f, 1.f, 1.f);
	if (FAILED(pGameInstance->Add_Light(m_pDevice, m_pContext, LightDesc)))
	...
	ZeroMemory(&LightDesc, sizeof(LIGHTDESC));
	LightDesc.eType = LIGHTDESC::TYPE_POINT5;
	LightDesc.vPosition = _float4(0.f, 118.f, 236.f, 1.f);
	LightDesc.fRange = 138.f;
