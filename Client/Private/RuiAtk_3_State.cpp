...
CRuiState * CAtk_3_State::Late_Tick(CRui* pRui, _float fTimeDelta)
{
	...
	if (!m_bEffect)
	{
		...
		pEffectManger->Create_Effect(CEffect_Manager::EFF_RUIATK3_1, pRui);
		pEffectManger->Create_Effect(CEffect_Manager::EFF_RUIATK3_2, pRui);
...
void CAtk_3_State::Enter(CRui* pRui)
{
	...
	if (iRand == 0)
		...
		CSoundMgr::Get_Instance()->PlayEffect(TEXT("Rui_Attack2_1.wav"), fEFFECT);
	else if (iRand == 4)
		CSoundMgr::Get_Instance()->PlayEffect(TEXT("Rui_Attack2_2.wav"), fEFFECT);
	else if (iRand == 5)
		CSoundMgr::Get_Instance()->PlayEffect(TEXT("Rui_Attack2_3.wav"), fEFFECT);
...
CRuiState * CAtk_3_State::CommandCheck(CRui * pRui)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
