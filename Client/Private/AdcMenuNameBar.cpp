...
HRESULT CAdcMenuNameBar::Render()
{
	...
	if (iStageNum == 0)
		pGameInstance->Render_Font(TEXT("Font_Nexon"), TEXT("히노카미 카구라 편"), XMVectorSet(m_fX, m_fY, 0.f, 1.f), XMVectorSet(1.f, 1.f, 1.f, 1.f), XMVectorSet(1.f, 1.f, 0.f, 1.f));
	else 
		pGameInstance->Render_Font(TEXT("Font_Nexon"), TEXT("무한열차 아카자 편"), XMVectorSet(m_fX, m_fY, 0.f, 1.f), XMVectorSet(1.f, 1.f, 1.f, 1.f), XMVectorSet(1.f, 1.f, 0.f, 1.f));
