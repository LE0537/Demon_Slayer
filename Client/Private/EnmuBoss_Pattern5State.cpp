...
CEnmuBossState * CEnmuBoss_Pattern5State::Late_Tick(CEnmuBoss * pEnmuBoss, _float fTimeDelta)
{
	if (m_eStateType == CEnmuBossState::TYPE_START)
	{
		if (m_iHit == 0)
		{
			...
			{
				pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_FLASH, dynamic_cast<CEnmu_Left_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_LEFT_HAND])->Get_WeaponWorld());
				pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_HAND, dynamic_cast<CEnmu_Left_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_LEFT_HAND])->Get_WeaponWorld());
				pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_WIND, dynamic_cast<CEnmu_Left_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_LEFT_HAND])->Get_WeaponWorld());
			}
			else if (m_eParts == CEnmuBoss::PARTS::PARTS_RIGHT_HAND)
			{
				pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_HAND, dynamic_cast<CEnmu_Right_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_RIGHT_HAND])->Get_WeaponWorld());
				pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_FLASH, dynamic_cast<CEnmu_Right_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_RIGHT_HAND])->Get_WeaponWorld());
				pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_WIND, dynamic_cast<CEnmu_Right_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_RIGHT_HAND])->Get_WeaponWorld());
			}
	...
	if (m_eStateType == CEnmuBossState::TYPE_END)
	{
		...
		if (m_iHit == 0)
		{
			...
			if (m_eParts == CEnmuBoss::PARTS::PARTS_LEFT_HAND)
			{
				...
				//pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_FLASH, dynamic_cast<CEnmu_Left_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_LEFT_HAND])->Get_WeaponWorld());
				//pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_WIND, dynamic_cast<CEnmu_Left_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_LEFT_HAND])->Get_WeaponWorld());
				//pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_GROUND2, dynamic_cast<CEnmu_Left_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_LEFT_HAND])->Get_WeaponWorld());
			}
			else if (m_eParts == CEnmuBoss::PARTS::PARTS_RIGHT_HAND)
			{
				...
				//pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_FLASH, dynamic_cast<CEnmu_Right_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_RIGHT_HAND])->Get_WeaponWorld());
				//pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_WIND, dynamic_cast<CEnmu_Right_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_RIGHT_HAND])->Get_WeaponWorld());
				//pEffectManger->Create_Effect(CEffect_Manager::EFF_ENMUBOSS_PAT5_GROUND2, dynamic_cast<CEnmu_Right_Hand*>(pEnmuBoss->Get_EnmuPartsList()[CEnmuBoss::PARTS::PARTS_RIGHT_HAND])->Get_WeaponWorld());
			}
			RELEASE_INSTANCE(CEffect_Manager);
			++m_iHit;
		}
...
void CEnmuBoss_Pattern5State::Enter(CEnmuBoss * pEnmuBoss)
{
	...
	case Client::CEnmuBossState::TYPE_START:
		...
		if (m_eParts == CEnmuBoss::PARTS::PARTS_RIGHT_HAND)
		{
			...
			CSoundMgr::Get_Instance()->PlayVoice(TEXT("BossEnmu_Pattern_4.wav"), g_fVoice);//¼Õ¹Ù´ÚÂï±â
		}
		// LEFT_HAND
		else if (m_eParts == CEnmuBoss::PARTS::PARTS_LEFT_HAND)
		{
		...
		CSoundMgr::Get_Instance()->PlayEffect(TEXT("BossEnmu_SE_Pattern_04.wav"), g_fEffect);
		break;
	case Client::CEnmuBossState::TYPE_LOOP:
		// RIGHT_HAND
		if (m_eParts == CEnmuBoss::PARTS::PARTS_RIGHT_HAND)
		...
		CSoundMgr::Get_Instance()->PlayEffect(TEXT("BossEnmu_SE_Pattern_04_1.wav"), g_fEffect);
		break;
	case Client::CEnmuBossState::TYPE_END:
		// RIGHT_HAND
		if (m_eParts == CEnmuBoss::PARTS::PARTS_RIGHT_HAND)
