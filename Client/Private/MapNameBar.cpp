...
HRESULT CMapNameBar::Render()
{
	...
	pGameInstance->Render_Font(TEXT("Font_Nexon"), TEXT("³ªÅ¸±¸¸ð »ê ÃÊÀÔ"), XMVectorSet(m_fX - 115.f, m_fY - 23.f, 0.f, 1.f), XMVectorSet(0.f, 0.f, 0.f, m_fFadeTime), XMVectorSet(0.9f, 0.9f, 0.f, 1.f));
