...
void CEnmu_Left_Hand::Tick(_float fTimeDelta)
{
	...
	CHierarchyNode*		pSocket = m_pModelCom->Get_BonePtr("L_Hand");
	if (nullptr == pSocket)
		return;
...
_float4 CEnmu_Left_Hand::Check_CollPos()
{
	CHierarchyNode*		pRightHand = m_pModelCom->Get_BonePtr("L_FingerE_End");
	CHierarchyNode*		pLeftHand = m_pModelCom->Get_BonePtr("L_FingerA_End");
