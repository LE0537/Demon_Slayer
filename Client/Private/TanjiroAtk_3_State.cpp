...
void CAtk_3_State::Enter(CTanjiro * pTanjiro)
{
	...
	if (iRand == 0)
		CSoundMgr::Get_Instance()->PlayVoice(TEXT("Tanjiro_Attack3_1.wav"), fVOICE);
	else if (iRand == 1)
		CSoundMgr::Get_Instance()->PlayVoice(TEXT("Tanjiro_Attack3_2.wav"), fVOICE);
	else if (iRand == 2)
		CSoundMgr::Get_Instance()->PlayVoice(TEXT("Tanjiro_Attack3_3.wav"), fVOICE);
	...
	if (pTanjiro->Get_BattleTarget()->Get_TargetState() == STATE_HIT)
	{
		...
		CSoundMgr::Get_Instance()->PlayEffect(TEXT("Tanjiro_SE_Attack_3.wav"), fEFFECT);
}
