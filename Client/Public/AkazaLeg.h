...
class CAkazaLeg : public CCharacters
{
public:
	enum ANIMID
	{
...
public:
	CAkazaLeg(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CAkazaLeg(const CAkazaLeg& rhs);
	virtual ~CAkazaLeg() = default;
...
public:
	static CAkazaLeg* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
