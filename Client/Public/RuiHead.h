...
class CRuiHead : public CCharacters
{
public:
	CRuiHead(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRuiHead(const CRuiHead& rhs);
	virtual ~CRuiHead() = default;
...
public:
	static CRuiHead* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
