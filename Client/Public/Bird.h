...
class CBird : public CCharacters
{
public:
	CBird(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
public:
	static CBird* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
