...
public:
	enum EFFECT { EFF_HIT, EFF_TANATTACK1, EFF_TANATTACK2_1, EFF_TANATTACK2_2, EFF_TANATTACK3, EFF_TANATTACK4,
		EFF_WATER2_1, EFF_RGKATK1, EFF_RGKATK2_1, EFF_RGKATK2_2, EFF_RGKATK3, EFF_RGKATK4,
		EFF_RGKSKL_3KIEN_START, EFF_RGKSKL_3KIEN_MAIN, EFF_RGKSKL_2NOBORI_1, EFF_RGKSKL_2NOBORI_2, 
		EFF_RGKSKL_5TIGER_CHARGE, EFF_RGKSKL_5TIGER_MAIN, EFF_END };
public:
	CEffect_Manager();
