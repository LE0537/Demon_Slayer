...
public:
	enum EFFECT {
		...
		EFF_AKZATK_1, EFF_AKZATK_2, EFF_AKZATK_2_PTC, EFF_AKZATK_3, EFF_AKZATK_4,																									//	Akaza Atk
		...
		EFF_SPL_AKA_START, EFF_SPL_AKA_START_GROUND, EFF_SPL_AKA_START_HIT, EFF_SPL_AKA_END_GROUND, EFF_SPL_AKA_END_GROUND_NOTIME,
