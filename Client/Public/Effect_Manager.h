...
public:
	enum EFFECT {
		...
		EFF_SPL_AKA_MO1_HIT, EFF_SPL_AKA_MO2_GROUND, EFF_SPL_AKA_MO3_GROUND, 
		...
		EFF_SPL_AKA_MO8_BG1, EFF_SPL_AKA_MO8_HAND1, EFF_SPL_AKA_MO8_PROJ1, EFF_SPL_AKA_MO9_AURA1, EFF_SPL_AKA_MO9_BG1,
		EFF_TRAIN_SMOKE, EFF_TRAIN_WIND, EFF_FADE, EFF_END };
