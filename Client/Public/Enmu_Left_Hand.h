...
class CEnmu_Left_Hand : public CCharacters
{
public:
	enum ANIMID
	{
...
public:
	CEnmu_Left_Hand(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEnmu_Left_Hand(const CEnmu_Left_Hand& rhs);
	virtual ~CEnmu_Left_Hand() = default;
...
public:
	...
	_vector GET_LeftHandOriginLook() { return m_vOriginalLook; }
private:
	void HandleInput();
...
public:
	static CEnmu_Left_Hand* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
