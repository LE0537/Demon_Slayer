...
namespace Client
{
	...
	enum LEVEL { LEVEL_STATIC, LEVEL_LOADING, LEVEL_LOGO, LEVEL_GAMEPLAY, LEVEL_SELECTCHAR, LEVEL_GAMERESULT, LEVEL_MENU, LEVEL_STORYMENU, LEVEL_ADVRUI, LEVEL_SELECTMAP,LEVEL_ADVAKAZA,LEVEL_BATTLEENMU,LEVEL_BOSSENMU ,LEVEL_END };
