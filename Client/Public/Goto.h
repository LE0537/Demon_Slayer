...
class CGoto : public CCharacters
{
public:
	CGoto(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CGoto(const CGoto& rhs);
	virtual ~CGoto() = default;
...
public:
	static CGoto* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
