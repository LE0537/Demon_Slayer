...
class CAkazaBody : public CCharacters
{
public:
	enum ANIMID
	{
...
public:
	CAkazaBody(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CAkazaBody(const CAkazaBody& rhs);
	virtual ~CAkazaBody() = default;
