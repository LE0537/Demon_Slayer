...
class CDeer2 : public CCharacters
{
public:
	CDeer2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDeer2(const CDeer2& rhs);
	virtual ~CDeer2() = default;
...
public:
	static CDeer2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
