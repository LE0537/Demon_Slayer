...
class CTanjiroSheath final : public CGameObject
{
public:
...
private:
	...
	CTanjiroSheath(const CTanjiroSheath& rhs);
	virtual ~CTanjiroSheath() = default;
...
public:
	static CTanjiroSheath* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
