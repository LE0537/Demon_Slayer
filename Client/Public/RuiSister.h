...
class CRuiSister : public CCharacters
{
public:
	CRuiSister(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRuiSister(const CRuiSister& rhs);
	virtual ~CRuiSister() = default;
...
public:
	static CRuiSister* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
