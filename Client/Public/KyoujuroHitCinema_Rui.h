...
class CHitCinema_Rui : public CKyoujuroState
{
public:
	enum CINEMASCENE { SCENE_START, SCENE_0, SCENE_1, SCENE_2, SCENE_3, SCENE_4, SCENE_5, SCENE_6, SCENE_END };
	enum SCENE_ANIM
	{
		ANIM_SCENE_DMG_010 = 127,
		ANIM_SCENE_DMG_030 = 128,
		ANIM_SCENE_DMG_040 = 129,
		ANIM_SCENE_DMG_060 = 130,
		ANIM_SCENE_DMG_070 = 131,
		ANIM_SCENE_END,
	};
public:
