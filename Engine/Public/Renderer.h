...
public:
	...
	enum VALUETYPE { VALUE_FOGPOWER, VALUE_FOGDISTANCE, VALUE_FOGRANGE, VALUE_AO, VALUE_AORADIUS, VALUE_GLOWBLURCOUNT, VALUE_DISTORTION, VALUE_OUTLINE, VALUE_INNERLINE, VALUE_END };
private:
