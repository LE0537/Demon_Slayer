...
{
public:
	enum RENDERGROUP {RENDER_PRIORITY, RENDER_STATIC_SHADOWDEPTH, RENDER_SHADOWDEPTH, RENDER_NONALPHABLEND, RENDER_NONLIGHT, RENDER_BACKEFFECT, RENDER_ALPHABLEND,
	...
	enum VALUETYPE { VALUE_FOGCOLOR_R, VALUE_FOGCOLOR_G, VALUE_FOGCOLOR_B, VALUE_FOGDISTANCE, VALUE_FOGRANGE, VALUE_FOGMINPOWER, VALUE_CUBEMAPFOG, VALUE_AO, VALUE_AORADIUS, VALUE_GLOWBLURCOUNT, VALUE_DISTORTION, VALUE_OUTLINE, VALUE_INNERLINE, 
		VALUE_ENVLIGHT, VALUE_LIGHTSHAFT, VALUE_LIGHTSHAFT_TESTLENGTH, VALUE_LIGHTSHAFT_MINUS, VALUE_LIGHTPOWER, VALUE_SHADOWTESTLENGTH, VALUE_PLC_SHADOW, VALUE_MAPGRAYSCALETIME, VALUE_POINTBLURPOWER, VALUE_MOTIONBLURPOWER,
		VALUE_SHADOWPOWER, VALUE_END };
private:
