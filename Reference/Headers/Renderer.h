...
public:
	...
	enum VALUETYPE { VALUE_FOGCOLOR_R, VALUE_FOGCOLOR_G, VALUE_FOGCOLOR_B, VALUE_FOGDISTANCE, VALUE_FOGRANGE, VALUE_AO, VALUE_AORADIUS, VALUE_GLOWBLURCOUNT, VALUE_DISTORTION, VALUE_OUTLINE, VALUE_INNERLINE, VALUE_END };
private:
