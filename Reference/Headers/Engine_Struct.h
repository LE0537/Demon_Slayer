...
namespace Engine
{
	enum CHANNELID { SOUND_EFFECT, SOUND_BGM, SOUND_VOICE, SOUND_DIALOG, MAXCHANNEL };
	...
	{
		enum TYPE { TYPE_DIRECTIONAL, TYPE_POINT1, TYPE_POINT2, TYPE_POINT3, TYPE_POINT4, TYPE_POINT5,
			TYPE_EFFPOINT1, TYPE_EFFPOINT2, TYPE_EFFPOINT3, 
			TYPE_EFF1, TYPE_EFF2, TYPE_EFF3, 
			TYPE_FIELDSHADOW, TYPE_BATTLESHADOW, TYPE_RUISHADOW, TYPE_END };
