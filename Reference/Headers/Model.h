...
public: // 민준 추가 키프레임 가져오기
	...
	void	Set_DurationTime(_uint iAnimationNum, _float fDurationTime);
...
//------------------Instancing-------------------------------------------------
public:
	void	Update_Instancing(vector<VTXMATRIX> vecMatrix, _float fRadiusRatio, _float fTimeDelta, _float fCamDistCull = 0.f);
//------------------Instancing-------------------------------------------------
...
public:
	...
	HRESULT Play_Animation_Skill(_float fTimeDelta, _bool bRemoveTranslation = false);
